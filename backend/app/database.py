...
def _migrate_schema():
    ...
    migrations = [
        ...
        ("todo_items", "parent_id", "INTEGER REFERENCES todo_items(id) ON DELETE CASCADE"),
        ("todo_items", "work_status", "TEXT DEFAULT 'waiting'"),
        ("todo_items", "started_at", "DATETIME"),
        ("todo_items", "paused_at", "DATETIME"),
        ("todo_items", "total_working_seconds", "INTEGER DEFAULT 0"),
        ("todo_items", "stop_count", "INTEGER DEFAULT 0"),
